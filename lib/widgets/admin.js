...
function renderAdminTemplate() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    return yield webserver_1.default.app.renderAsync('admin/partials/widget-settings', {
      groups: groupsData
...
function getAvailableWidgets() {
  return __awaiter(this, void 0, void 0, function* () {
    // The next line calls a function in a module that has not been updated to TS yet
    // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access, @typescript-eslint/no-unsafe-assignment
    const [availableWidgets, adminTemplate] = yield Promise.all([plugins_1.default.hooks.fire('filter:widgets.getWidgets', []), renderAdminTemplate()]);
...
function get() {
  return __awaiter(this, void 0, void 0, function* () {
    const [areas, availableWidgets] = yield Promise.all([getAreas(), getAvailableWidgets()]);
    return {
